    ...
    return (
        <section data-avi className={styles.intro}>
            <div className={styles.introContent}>
                ...
                <SectionDesc className={styles.introDesc}>Мы создаём сервисы, исследуем технологии и делимся опытом
                    разработки. <br/>
            ...
            <PlanetSystem/>
            <Image alt={'Солнечная система'} data-hide-on-theme="light" className={styles.solarSystem}
                   src={SolarSystemImage}/>
            <Image alt={'Солнечная система'} data-hide-on-theme="dark" className={styles.solarSystem}
                   src={SolarSystemBlackImage}/>
