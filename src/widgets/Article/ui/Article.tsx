        ...
        <div className={styles.articleColumn}>
            ...
            <article className={styles.article}>
                ...
                <div className={styles.articleTop}>
                    ...
                    <button className={styles.articleShare}><Image src={ShareIcon} alt={'Поделиться'}
                                                                   className={styles.articleShareIcon}/></button>
                </div>
                ...
                <div className={`${styles.articleContent}`}>
                    <div className={`${styles.articleDesc} article-content`} dangerouslySetInnerHTML={{
                        __html: renderArticle(
                    ...
                    <div className={styles.articleRecommend}>
                        ...
                        <ul className={styles.articleRecommendList}>
                            {responseRecommend.data.map(recommend =>
                                <BlogItem slug={recommend.slug} key={recommend.id} image={recommend.image}
                                          id={String(recommend.id)} className={styles.articleRecommendItem}
                                          title={recommend.title} description={recommend.description}/>
                            )}
                        </ul>
                    </div>
                }
